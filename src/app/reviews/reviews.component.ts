...
export class ReviewsComponent {
  ...
  onResize(event: Event) { setTimeout(()=>{
    ...
    this.slider.style.left = `${(this.sliderOuter.offsetWidth / 2) - (this.newActiveSlide.offsetLeft + this.newActiveSlide.offsetWidth / 2)}px`;
