  ...
  projects: ProjectsInterface[] = [
    {
      ...
      index: 0,
      pLangs: [
        { pLang: 'HTML', pIconSrc: 'assets/images/projekt-overlay-icons/html-icon.svg' },
        { pLang: 'CSS', pIconSrc: 'assets/images/projekt-overlay-icons/css-icon.svg' },
        { pLang: 'JavaScript', pIconSrc: 'assets/images/projekt-overlay-icons/java-script-icon.svg' },
        { pLang: 'Firebase', pIconSrc: 'assets/images/projekt-overlay-icons/firebase-icon.svg' }
      ],
      description: {
